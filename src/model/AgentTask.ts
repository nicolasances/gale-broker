...
export class AgentTaskRequest {
    ...
    subtaskGroupId?: string; // Optional group ID to group related subtasks together.

    constructor({ command, taskId, taskInputData, correlationId, taskInstanceId, parentTask, subtaskGroupId }: AgentTaskRequest) {
        ...
        this.subtaskGroupId = subtaskGroupId;
    }
    ...
    static fromHTTPRequest(req: any): AgentTaskRequest {
        ...
        if (req.body.command.command === 'resume' && !req.body.command.completedSubtaskGroupId) throw new ValidationError(400, "Missing mandatory field: completedSubtaskGroupId for resume command. Received: " + JSON.stringify(req.body));
        ...
        return new AgentTaskRequest({
            ...
            subtaskGroupId: req.body.subtaskGroupId || null,
        });
    }
}
